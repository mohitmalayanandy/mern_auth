      ...
      <div className='bg-black p-10 rounded-lg shadow-lg w-full sm:w-96 text-indigo-300'>
        ...
        {!isEmailSent &&
          <form onSubmit={onSubmitEmail}>
            ...
            <p className='text-center text-sm mb-6'>Enter your registered email</p>
        ...
        {isOtpSubmited && isEmailSent &&
          <form onSubmit={onSubmitNewPassword}>
            ...
            <p className='text-center text-sm mb-6'>Enter enter the new password</p>
            <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-3xl bg-slate-600'>
              <img src={assets.lock_icon} alt="" />
              <input onChange={(e) => setNewPassword(e.target.value)} value={newPassword} type="password" placeholder='Password' required className='outline-none bg-transparent' />
            </div>
            <button type='submit' className='w-full py-2.5 rounded-full bg-gradient-to-r from-blue-500 to-green-500'>Set New Password</button>
          </form>
        }
